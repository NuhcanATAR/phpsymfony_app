 ...
 */
final class Version20240814094131 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        // $this->addSql('CREATE TABLE user_profile (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, name VARCHAR(255) NOT NULL, bio VARCHAR(255) NOT NULL, web_site_url VARCHAR(255) DEFAULT NULL, twitter_user_name VARCHAR(255) NOT NULL, company VARCHAR(255) DEFAULT NULL, location VARCHAR(255) DEFAULT NULL, date_of_birth DATE DEFAULT NULL, UNIQUE INDEX UNIQ_D95AB405A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
